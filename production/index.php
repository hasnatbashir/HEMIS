              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-usd"></i> Payroll <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="index2.html">Salary</a></li>
                    <li><a href="index3.html">Loans</a></li>
                  </ul>
                </li>
              </ul>
            </div>
        ...
        <div class="row">
          <form action="index.php" method="GET">
            <div class="title_right">
              <input type="checkbox" id="loan" value="yes" data-parsley-mincheck="2" required class="flat col-md-2" /> Loan
