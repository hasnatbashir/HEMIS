                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">Payment #</label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">Dated</label>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">Sum of Ruppees</label>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    <input type="text" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">In Words</label>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    <input type="text" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">Received By</label>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    <input type="text" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">Prepared By</label>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    <input type="text" class="form-control">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">Zip Code</label>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    <input type="text" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">Cheque Amount</label>
                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    <input type="text" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="x_panel">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2>ABC Company <small>f-6/2 MG Road Islamabad</small></h2>
                                                <br>
                                                <h2>HDFS Bank<small> f-10/2 Bella Road Islamabad</small></h2>
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>0063</td>
                                                            <td>Abdullah</td>
                                                            <td>Salary for the month of April</td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">2</th>
                                                            <td>0064</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row"></th>
                                                            <td>
                                                                Amount (in words) : One Lakh Twenty Nine Thousand.
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
